...
const ExpandedCard = () => {
  return (
    <div className={styles.ExpandedCard}>
      ...
      <div className={styles.subheader_}>
        <h1>Project Title</h1>
      </div>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
        labore et dolore magna aliqua. Hendrerit dolor magna eget est lorem ipsum dolor sit amet.
        Aliquam faucibus purus in massa tempor nec feugiat nisl. Malesuada bibendum arcu vitae
        elementum curabitur vitae nunc. Magnis dis parturient montes nascetur ridiculus mus mauris
        vitae. Blandit massa enim nec dui. Interdum posuere lorem ipsum dolor sit amet consectetur
        adipiscing. Sed risus ultricies tristique nulla aliquet enim. Venenatis tellus in metus
        vulputate eu scelerisque. Egestas pretium aenean pharetra magna. Commodo quis imperdiet
        massa tincidunt nunc pulvinar sapien. Eros in cursus turpis
      </p>
